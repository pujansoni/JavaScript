...
form.addEventListener("submit", function(e) {
    // The preventDefault() will prevent the default behaviour of a form in HTML which is to submit the form to server, as we are not concerned with any form action in this project we will prevent this behaviour using the preventDefault() function
    e.preventDefault();
    // Even thought the input type is number we will receive a string when we enter an input and click on the "generate" button
